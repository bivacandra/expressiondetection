...
def yolo3(path):
    ...
    with open('yolo_custom_data/classes.names') as f:
    ...
    network = cv2.dnn.readNetFromDarknet('yolo_custom_data/yolov3_custom_test.cfg',
                                         'yolo_custom_data/yolov3_custom_best.weights')
